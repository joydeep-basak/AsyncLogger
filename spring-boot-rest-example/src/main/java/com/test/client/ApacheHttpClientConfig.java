...
public class ApacheHttpClientConfig {
  ...
  private final Logger LOG = LogManager.getLogger(ApacheHttpClientConfig.class);
  
  private static final Long DEFAULT_KEEP_ALIVE_TIME = 500000l;
  
  private static final int MAX_TOTAL_CONNECTIONS = 10000;
  
  private static final int MAX_ROUTE_CONNECTIONS = 1000;
  
  private static final int MAX_LOCALHOST_CONNECTIONS = 1000;
  
  private static final Long IDLE_CONNECTION_WAIT_TIME = 10000l;
  ...
  public PoolingHttpClientConnectionManager poolingConnectionManager() {
    ...
    HttpHost localhost = new HttpHost("http://localhost", 9080);
